...
def calc_aqi_and_mean_concentration_and_merge(
        source_data_path: str, pollutants_codes: list[int], date_from: str, date_end: str) -> pd.DataFrame:
    df_gen = pd.DataFrame(
...
def get_lag_data_concentration(pollutants_codes: list[int],
                               df_gen: pd.DataFrame,
                               id_cols: [],
                               filters: [],
                               windows: dict,
...
def get_all_lag_data(pollutants_codes: list[int],
                     df_gen: pd.DataFrame,
                     lags_shift: list[int],
                     filters_aqi: list[str],
                     windows_filters_aqi: dict,
